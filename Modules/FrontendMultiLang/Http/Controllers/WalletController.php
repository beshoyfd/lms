...
namespace Modules\FrontendMultiLang\Http\Controllers;
...
class FrontendMultiLangController extends Controller
{
    ...
    {
        return view('frontendMultiLang::index');
    }
    ...
    public function returnAmountTofrontendMultiLang($refund_infos)
    {
        try {
