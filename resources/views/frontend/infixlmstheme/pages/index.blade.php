...
@section('mainContent')
    ...
    <section class="bg-secondary py-5">
        <div class="container text-center pt-5 mt-lg-4 mt-xl-5">
            ...
            <div class="position-relative mx-auto my-3" style="max-width: 950px;">
                <h1 class="display-4 position-relative z-2 mb-0">{{__('Unleash Your Professional Power')}}</h1>
            ...
            <p class="fs-lg pb-3 mb-2 mb-sm-3 mb-lg-4 mx-auto" style="max-width: 640px;">{{__('Every Course Opens Doors for New Opportunities')}}</p>
            <a class="btn btn-lg btn-primary" href="{{route('courses')}}">{{__('Explore Courses')}}</a>
        </div>
    </section>

    <!-- OWL -->
    <section class="container py-3 my-sm-2 my-md-2 my-lg-3 home-page">
            ...
            <div class="container pt-2">
                ...
                <div class="services">
                    <div class="owl-carousel owl-theme">
                        @php
                            $colors = ['#CD191D','#2A3261', '#CD191D', '#CD191D','#2A3261', '#CD191D','#CD191D','#2A3261', '#CD191D'];
                        @endphp
    ...
    <!-- Curved edge -->
    <div class="d-none w-100 justify-content-center overflow-hidden" style="color: var(--ar-gray-100);">
    ...
    <x-home-page-brand-section :homeContent="$homeContent"></x-home-page-brand-section>
    <!-- Features -->
{{--    <section class="container py-5 my-sm-2 my-md-4 my-lg-5 d-none">--}}
        ...
        <div class="container pt-lg-2 pt-xl-4 pt-xxl-5 pb-1 pb-sm-3">
            <div class="row pt-sm-3 pt-md-4">
                <div class="col-md-6 col-xl-5 offset-xl-1">
                    <h2 class="display-4">{{__("Subscribe in JOY newsletter")}}</h2>
                </div>
