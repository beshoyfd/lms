...
@section('mainContent')
    ...
    <div class="container my-5">
        <div class="card text-center shadow-sm border-0 subscribe-newsletter">
            <div class="row no-gutters align-items-center">
                <div class="col-md-4">
                    <img src="{{asset('/public/frontend2/vendor/subscribe-img.webp')}}" class="card-img"
                         alt="Newsletter Image">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
                        <h5 class="card-title text-right">
                            <strong>Subscribe</strong> in Bakkah newsletter and don't miss a thing with our offers, new
                            courses & more!
                        </h5>
                        <form action="{{route('subscribe')}}"
                            ...
                            <button class="btn btn-primary btn-sm w-100 mt-3">{{__('frontend.Subscribe Now')}}</button>
                            <div class="info">
